...
map("n", "<leader>bt",
    "<CMD>lua TelescopeOpenPrewiev('current_buffer_tags')<CR>")
...
map("n", "<leader>ld",
    "<CMD>lua TelescopeOpenPrewiev('lsp_document_symbols')<CR>")
map("n", "<leader>lw",
    "<CMD>lua TelescopeOpenPrewiev('lsp_workspace_symbols')<CR>")
