...
local lsp = {
    "glepnir/lspsaga.nvim", "nvim-telescope/telescope.nvim",
    "nvim-lua/popup.nvim", "nvim-lua/plenary.nvim", "neovim/nvim-lspconfig",
...
local cmp = {
    "hrsh7th/nvim-cmp", "hrsh7th/cmp-buffer", "hrsh7th/cmp-nvim-lua",
    "hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-path", "hrsh7th/cmp-vsnip",
    "hrsh7th/vim-vsnip", "hrsh7th/cmp-cmdline"
    --  {"tzachar/cmp-fuzzy-buffer", requires = {"hrsh7th/nvim-cmp", "tzachar/fuzzy.nvim"}}
}

local git = {
    "tpope/vim-fugitive", "tpope/vim-rhubarb", "rhysd/conflict-marker.vim", -- Highlight conflict markers.[x and ]x, ct for themselves, co for ourselves, cn for none and cb
...
local ui = {
    -- "noib3/cokeline.nvim",
    "beauwilliams/focus.nvim", -- "mhinz/vim-startify", -- start screen
    "kyazdani42/nvim-web-devicons", --  "akinsho/nvim-bufferline.lua",
    -- "kyazdani42/nvim-tree.lua",
    'ms-jpq/chadtree', --  "folke/lsp-trouble.nvim",
...
packer.startup {
    {
        init, fzf, cmp, lsp, git, misk, snippets, themes, ui
        --  langs,
        --  test
    },
